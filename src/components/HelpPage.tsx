...
import { Grommet, Box, Text,Heading,Button,Tab,Tabs} from 'grommet';

const Help: React.FC = () => {
    return (
        <Grommet full theme={loftryTheme}>
                  <Box fill={true} overflow="auto" align="center" flex="grow" background={{"image":"url('https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80')"}}>
        ...
        <Box align="center" justify="start" width="xlarge" background={{"color":"white"}} overflow="visible" pad="medium">
